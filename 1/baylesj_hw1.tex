...
\lstinputlisting[language=Verilog]{fadder.sv}
\lstinputlisting[language=Verilog]{adder8.sv}
\lstinputlisting[language=Verilog]{adder8.do}
\lstinputlisting[language=Verilog]{syn_adder8}
